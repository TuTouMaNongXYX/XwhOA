package com.xwh.it.configure.aop;
...
public class LogsAop {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.xwh.*.controller.*.*(..)) && !@annotation(com.xwh.it.configure.annotation.NoAuto)")
    public void log() {
    }
...
//        日志
        Logs logs = Logs.builder()
                .logId(IdUtil.getUUIDTOLong().toString())
